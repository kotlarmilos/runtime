...
#if !defined(TARGET_APPLE) && !defined(TARGET_ANDROID) && defined(TARGET_UNIX) && (defined(TARGET_ARM64) || defined(TARGET_LOONGARCH64))
...
#endif // !TARGET_APPLE && !TARGET_ANDROID && TARGET_UNIX && (TARGET_ARM64 || TARGET_LOONGARCH64)
