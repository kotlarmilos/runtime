...
namespace System.Reflection.Tests
{
    public class ModuleTests
    {
        ...
        [Fact]
        [ActiveIssue("https://github.com/dotnet/runtime/issues/126730", typeof(PlatformDetection), nameof(PlatformDetection.IsNativeAot), nameof(PlatformDetection.IsAppleMobile))]
